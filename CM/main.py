...
def Database():
    ...
    cursor = conn.cursor()
    try:
        cursor.execute("CREATE TABLE `member` (mem_id INTEGER(100) NOT NULL  PRIMARY KEY AUTO_INCREMENT, firstname varchar(255), lastname varchar(255), gender varchar(255), age varchar(255), address varchar(255), contact varchar(255))")
    except:
